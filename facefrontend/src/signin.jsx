...
const Signin = ({ classname }) => {
    ...
    return (
        <div className="mx-auto flex h-screen max-w-lg flex-col md:max-w-none md:flex-row md:pr-10">
            <div className="max-w-200 rounded-3xl bg-linear-to-t from-blue-700 via-blue-700 to-blue-600 px-4 py-10 text-white sm:px-10 md:m-6 md:mr-8">
                <p className="mb-20 font-bold tracking-wider">Third Year Computer Engineering</p>
                <p className="mb-4 text-3xl font-bold md:text-4xl md:leading-snug">
                    Welcome to <br />
                    <span className="text-yellow-300">Rajendra Mane College of Engineering & Technology</span>
                </p>
                ...
                <div className="bg-blue-600/80 rounded-2xl px-6 py-8">
                    ...
                    <div className="flex items-center">
                        ...
                        <p className="">
                            <strong className="block text-yellow-300 font-medium">Department Of Computer Engineering</strong>
                    ...
                    {authMode === "login" ? (
                        <>
                            ...
                            <button
                                ...
                                className="w-full rounded-xl bg-linear-to-r from-blue-700 to-blue-600 px-8 py-3 font-bold text-white transition-all hover:opacity-90 hover:shadow-lg"
                            >
                                Sign In
                            </button>
                        </>
                        ...
                        <>
                            ...
                            <button onClick={handleSignup} className="w-full rounded-xl bg-linear-to-r from-blue-700 to-blue-600 px-8 py-3 font-bold text-white transition-all hover:opacity-90 hover:shadow-lg">
                                Sign Up
                            </button>
                        </>
                    )}
